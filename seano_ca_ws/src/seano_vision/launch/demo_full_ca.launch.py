...
def generate_launch_description():
    # --------------------
    # Launch arguments (gaya demo_risk)
    # --------------------
    ...
    # NOTE:
    # - Tidak passing url/swap_rb dll di sini
    # - Jadi kalau IP berubah, cukup edit di camera_rtsp.launch.py
    # --------------------
    camera_include = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution([FindPackageShare("seano_vision"), "launch", camera_launch])
        ),
    ...
    # --------------------
    # Viewer node (image_tools/showimage)
